...
<section className="rounded-[28px] border border-black/10 bg-white p-4 shadow-sm">
        ...
        {/* Tools card (horizontaal, zoals Ruimte) */}
        <section className="rounded-[28px] border border-black/10 bg-white p-4 shadow-sm">
          <div className="text-sm font-semibold text-black/80">Tools</div>
          ...
          <div className="mt-3 grid gap-3 md:grid-cols-4">
            <button
              ...
              className={clsx(
                "h-11 w-full rounded-2xl border border-black/10 bg-white px-3 text-sm font-medium shadow-sm hover:bg-black/5 active:scale-[0.98]",
                tool === "select" && "border-black/20 bg-black text-white hover:bg-black"
              )}
            >
              Select
            </button>
            ...
            <button
              ...
              className={clsx(
                "h-11 w-full rounded-2xl border border-black/10 bg-white px-3 text-sm font-medium shadow-sm hover:bg-black/5 active:scale-[0.98]",
                tool === "place" && "border-black/20 bg-black text-white hover:bg-black"
              )}
            >
              Plaats blok
            </button>
            ...
            <button
              ...
              className={clsx(
                "h-11 w-full rounded-2xl border border-black/10 bg-white px-3 text-sm font-medium shadow-sm hover:bg-black/5 active:scale-[0.98]",
                tool === "move" && "border-black/20 bg-black text-white hover:bg-black"
              )}
            >
              Verplaats
            </button>
            ...
            <button
              ...
              className={clsx(
                "h-11 w-full rounded-2xl border border-black/10 bg-white px-3 text-sm font-medium shadow-sm hover:bg-black/5 active:scale-[0.98]",
                tool === "delete" && "border-black/20 bg-black text-white hover:bg-black"
              )}
            >
              Verwijder
            </button>
